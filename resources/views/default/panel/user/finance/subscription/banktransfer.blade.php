            ...
            <div class="row row-cards">
                <div class="col-sm-8 col-lg-8">
                    ...
                    <form
                        ...
                        action="{{ route('dashboard.user.payment.subscription.checkout', ['gateway' => 'banktransfer']) }}"
                        method="post"
                    >
                        @csrf
                        <input
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label
                            class="form-label"
                            for="proof_image"
                        >{{ __('Upload Proof of Purchase') }}</label>
                        <input
                            class="form-control"
                            id="proof_image"
                            type="file"
...
@push('script')
    <script>
        ...
        function submitForm() {
            var proofImage = document.getElementById('proof_image').files[0];
            var proofImageInput = document.getElementById('proof_image');
            if (!proofImage) {
                alert('Please upload proof of purchase.');
                return;
            }
            var form = document.getElementById('bank-form');
            form.appendChild(proofImageInput);
            proofImageInput.style.display = 'none'; // Hide the file input
            form.submit();
        }
