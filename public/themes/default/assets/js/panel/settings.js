...
function xaiSettingsSave() {
	...
	formData.append('xai_api_secret', $("#xai_api_secret").val());
	formData.append('xai_default_model', $("#xai_default_model").val());

	$.ajax({
		type: "post",
		url: "/dashboard/admin/settings/x-ai-save",
		data: formData,
		contentType: false,
		processData: false,
		success: function (data) {
