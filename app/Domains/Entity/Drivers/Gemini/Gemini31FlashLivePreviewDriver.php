...
class Gemini31FlashLivePreviewDriver extends BaseDriver implements WithInputInterface, WithWordsInterface
{
    use HasInput;
    use HasWords;
    ...
    {
        return EntityEnum::GEMINI_3_1_FLASH_LIVE_PREVIEW;
    }
}
