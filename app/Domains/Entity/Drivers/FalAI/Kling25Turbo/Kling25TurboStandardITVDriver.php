...
class Kling25TurboStandardITVDriver extends BaseDriver implements WithImageToVideoInterface, WithInputVideoInterface
{
    use HasImageToVideo;
    use HasInputVideo;
    ...
    {
        return EntityEnum::KLING_2_5_TURBO_STANDARD_ITV;
    }
}
