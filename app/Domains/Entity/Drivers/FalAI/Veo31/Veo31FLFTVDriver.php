...
class Veo31FLFTVDriver extends BaseDriver implements WithInputVideoInterface, WithTextToVideoInterface
{
    use HasInputVideo;
    use HasTextToVideo;
    ...
    {
        return EntityEnum::VEO_3_1_FIRST_LAST_FRAME_TO_VIDEO;
    }
}
