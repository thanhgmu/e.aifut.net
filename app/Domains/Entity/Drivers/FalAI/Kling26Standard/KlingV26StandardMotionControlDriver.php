...
namespace App\Domains\Entity\Drivers\FalAI\Kling26Standard;
...
class KlingV26StandardMotionControlDriver extends BaseDriver implements WithImageToVideoInterface, WithInputVideoInterface
{
    use HasImageToVideo;
    use HasInputVideo;
    ...
    {
        return EntityEnum::KLING_2_6_STANDARD_MOTION_CONTROL;
    }
}
