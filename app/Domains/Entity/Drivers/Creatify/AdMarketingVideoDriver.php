...
namespace App\Domains\Entity\Drivers\Creatify;
...
class AdMarketingVideoDriver extends BaseDriver implements WithInputVideoInterface, WithTextToVideoInterface, WithVideoToVideoInterface
{
    use HasInputVideo;
    use HasVideoToVideo;
    ...
    {
        return EntityEnum::AD_MARKETING_VIDEO;
    }
}
